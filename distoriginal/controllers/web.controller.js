...
exports.obtenerTodosPedidos = obtenerTodosPedidos;
exports.PedidoAsignacion = PedidoAsignacion;
exports.PedidoDetallePlataforma = PedidoDetallePlataforma;
exports.Motorizados = Motorizados;
exports.PedidoPreparar = PedidoPreparar;
const database_1 = __importDefault(require("../classes/database"));
const database = database_1.default.instance;
function obtenerTodosPedidos(req, res) {
...
//Plataforma
function PedidoAsignacion(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        if (req.body.IdPedido != undefined) {
            let IdPedido = req.body.IdPedido;
            try {
                let conn = yield database.conexionObtener();
                let resultado = yield conn.query("SELECT Estado FROM Gen_Pedido WHERE IdPedido=" + IdPedido);
                let resultadofinal = JSON.parse(JSON.stringify(resultado[0]));
                if (resultadofinal.length > 0) {
                    if (resultadofinal[0].Estado == 'E') {
                        yield conn.query("UPDATE Gen_Pedido SET Estado ='PE' WHERE IdPedido = " + IdPedido);
...
function PedidoDetallePlataforma(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
...
function Motorizados(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        if (req.query.IdEmpresa != undefined) {
            ...
            try {
                let conn = yield database.conexionObtener();
                let resutaldoMotorizado = yield conn.query("SELECT Empresa_Has_Motorizado.IdMotorizado,CONCAT(Gen_Motorizado.Nombres,' ',Gen_Motorizado.Apellidos) AS Motorizado,Gen_Motorizado.Telefono, IFNULL(Viajes.Contador,0) AS ContadorViajes FROM Empresa_Has_Motorizado " +
...
function PedidoPreparar(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        if (req.body.IdPedido != undefined) {
            let IdPedido = req.body.IdPedido;
            try {
                let conn = yield database.conexionObtener();
                let resultadoPedido = yield conn.query("SELECT EnviarPreparar,IdMotorizado FROM Gen_Pedido WHERE IdPedido=" + IdPedido + " AND EnviarPreparar=0");
                let resultadofinalPedido = JSON.parse(JSON.stringify(resultadoPedido[0]));
                if (resultadofinalPedido.length > 0) {
                    if (resultadofinalPedido[0].IdMotorizado == null) {
                        ...
                        let resultado1 = yield conn.query("UPDATE Gen_Pedido SET  EnviarPreparar = 1 WHERE IdPedido =" + IdPedido);
